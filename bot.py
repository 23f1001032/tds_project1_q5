...
AIPIPE_TOKEN = "your-token-bot"
LOG_URL = "https://raw.githubusercontent.com/23f1001032/jsonl_file/refs/heads/main/run.jsonl"  # see Step 5 — where run.jsonl will be hosted
# -------------------------------------------
